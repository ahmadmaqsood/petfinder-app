...
const PetsAdoption: React.FC = () => {
    return (
        <div className=' PetsAdoption md:mt-24 xx:mt-14 '>
            ...
            <div className="grid lg:grid-cols-5 md:grid-cols-3 xx:grid-cols-2 gap-x-6  xx:gap-y-6 place-items-center ">
                <div className="card hover:border-primary hover:border-2 shadow-md w-[231px] h-[301px] flex  items-center justify-center flex-col   rounded-xl bg-white  text-center">
                ...
                <div className="card hover:border-primary hover:border-2 shadow-md w-[231px] h-[301px]  flex  items-center justify-center flex-col rounded-xl bg-primary  text-center  ">
